...
const Store = () => {
    ...
    const data = [
        ...
        { name: "Mijal", id: 2, price: 111, img: ['src/assets/pic2.avif', 'src/assets/pic2_1.avif'], description: 'Mijal ceramic table lamp with a white finish'},
        { name: "Noara", id: 3, price: 250, img: ['src/assets/pic3.avif', 'src/assets/pic3_1.avif'], description: 'Noara magnesium table lamp with a white finish'},
